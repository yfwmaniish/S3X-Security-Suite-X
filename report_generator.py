...
<head>
    ...
    <title>S3X-Security-Suite-X - {{ target }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by S3X-Security-Suite-X on {{ timestamp }}</p>
...
def main():
    parser = argparse.ArgumentParser(description='Generate HTML/PDF reports from S3X-Security-Suite-X scan results')
